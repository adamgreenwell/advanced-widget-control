...
if( !function_exists( 'widgetcontrol_settings_visibility' ) ):
	function widgetcontrol_settings_visibility(){
	    global $widget_options; ?>
	    <li class="widgetcontrol-module-card <?php echo ( $widget_options['visibility'] == 'activate' ) ? 'widgetcontrol-module-type-enabled' : 'widgetcontrol-module-type-disabled'; ?>" id="widgetcontrol-module-card-visibility" data-module-id="visibility">
			...
			<?php widgetcontrol_modal_start( $widget_options['visibility'] ); ?>
				...
				<table class="form-table widgetcontrol-settings-section">
					<tr>
						...
						<td>
							<input type="checkbox" id="widgetcontrol-visibility-post_types" name="visibility[post_type]" <?php echo ( isset( $widget_options['settings']['visibility'] ) ) ? widgetcontrol_is_checked( $widget_options['settings']['visibility'], 'post_type' ) : ''; ?> value="1" />
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="widgetcontrol-visibility-taxonomies" name="visibility[taxonomies]" <?php echo ( isset( $widget_options['settings']['visibility'] ) ) ? widgetcontrol_is_checked( $widget_options['settings']['visibility'], 'taxonomies' ) : ''; ?> value="1" />
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="widgetcontrol-visibility-misc" name="visibility[misc]" <?php echo ( isset( $widget_options['settings']['visibility'] ) ) ? widgetcontrol_is_checked( $widget_options['settings']['visibility'], 'misc' ) : ''; ?> value="1" />
			...
			<?php widgetcontrol_modal_end( $widget_options['visibility'] ); ?>
		</li>
	    <?php
	}
